    ...
    <div class="leases-layout">
        ...
        <div class="agreement-details">
            <div class="dashboard-section">
                ...
                <div class="empty-state" id="agreementDetailsPanel">
                    <i class="fas fa-file-contract" style="font-size: 3rem; color: var(--text-muted); margin-bottom: 1rem;"></i>
                    <p class="text-muted">Select an agreement to view details</p>
                </div>
            </div>
        </div>
    </div>
