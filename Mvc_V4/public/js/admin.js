// Admin Dashboard JavaScript - Complete Updated Version
...
function performSearch(query) {
  ...
  const rows = document.querySelectorAll('.data-table tbody tr, .managers-table tbody tr')
...
function initializeUI() {
  ...
  document.querySelectorAll(".data-table tbody tr, .managers-table tbody tr").forEach((row) => {
...
function exportTableData(format = 'csv') {
  const tables = document.querySelectorAll('.data-table, .managers-table')
  if (tables.length === 0) {
