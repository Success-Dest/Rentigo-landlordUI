...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/tenant.css">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <div class="logo">
                    ...
                    <span class="logo-text">TenantHub</span>
                </div>
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo URLROOT; ?>/tenant/search"
                            class="nav-link <?php echo ($data['page'] ?? '') === 'search' ? 'active' : ''; ?>"
                    ...
                    <li class="nav-item">
                        <a href="<?php echo URLROOT; ?>/tenant/track_issues"
                            ...
                            data-tooltip="Track Issue Status">
                            <i class="fas fa-clipboard-list"></i>
                            <span class="nav-text">Track Issue Status</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo URLROOT; ?>/tenant/reviews"
                            class="nav-link <?php echo ($data['page'] ?? '') === 'reviews' ? 'active' : ''; ?>"
                ...
                <div class="header-right">
                    <div class="user-menu">
                        <button class="user-menu-toggle">
                            ...
                            <span><?php echo $data['user_name'] ?? 'Tenant'; ?></span>
                            <i class="fas fa-chevron-down"></i>
                        </button>
                        <div class="user-dropdown">
                            <a href="<?php echo URLROOT; ?>/tenant/settings" class="dropdown-item">
