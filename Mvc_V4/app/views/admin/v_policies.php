            ...
            <table class="data-table policies-table">
                ...
                <tbody>
                    <tr data-status="active">
                        ...
                        <td>
                            <div class="policy-description">Guidelines for tenant screening and ap...</div>
                        </td>
                        <td>v2.1</td>
                        <td>15/06/2024</td>
                        ...
                        <td>
                            <div class="policy-actions">
                                <button class="action-btn view-btn" onclick="editPolicy('POL001')" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="action-btn deactivate-btn" onclick="deactivatePolicy('POL001')" title="Deactivate">
                                    Deactivate
                                </button>
                    ...
                    <tr data-status="active">
                        ...
                        <td>
                            <div class="policy-description">Rules regarding security deposit collecti...</div>
                        </td>
                        <td>v1.3</td>
                        <td>20/05/2024</td>
                        <td><span class="status-badge active">Active</span></td>
                        <td>
                            <div class="policy-actions">
                                <button class="action-btn view-btn" onclick="editPolicy('POL002')" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="action-btn deactivate-btn" onclick="deactivatePolicy('POL002')" title="Deactivate">
                                    Deactivate
                                </button>
                    ...
                    <tr data-status="draft">
                        ...
                        <td>
                            <div class="policy-description">Process for handling maintenance requ...</div>
                        </td>
                        <td>v1.0</td>
                        <td>01/07/2024</td>
                        ...
                        <td>
                            <div class="policy-actions">
                                <button class="action-btn view-btn" onclick="editPolicy('POL003')" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="action-btn activate-btn" onclick="activatePolicy('POL003')" title="Activate">
                                    Activate
                                </button>
...
<script>
    ...
    function activatePolicy(policyId) {
        if (confirm('Are you sure you want to activate this policy?')) {
            ...
            <button class="action-btn view-btn" onclick="editPolicy('${policyId}')" title="Edit">
                <i class="fas fa-edit"></i>
            </button>
            <button class="action-btn deactivate-btn" onclick="deactivatePolicy('${policyId}')" title="Deactivate">
                Deactivate
            </button>
    ...
    function deactivatePolicy(policyId) {
        if (confirm('Are you sure you want to deactivate this policy?')) {
            ...
            <button class="action-btn activate-btn" onclick="activatePolicy('${policyId}')" title="Activate">
                Activate
            </button>
            <button class="action-btn danger-btn" onclick="deletePolicy('${policyId}')" title="Delete">
                <i class="fas fa-trash"></i>
