...
<div class="page-content">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3 class="stat-number">$124,500</h3>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3 class="stat-number">$98,200</h3>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3 class="stat-number">$26,300</h3>
            ...
            <table class="data-table transactions-table">
                ...
                <tbody>
                    <tr data-type="income" data-status="approved" data-date="2024-01-07">
                        ...
                        <td>
                            <div class="amount-display income">$2,500</div>
                        </td>
                        <td>01/07/2024</td>
                    ...
                    <tr data-type="payment" data-status="pending" data-date="2024-02-07">
                        ...
                        <td>
                            <div class="amount-display payment">$250</div>
                        </td>
                        <td>02/07/2024</td>
                    ...
                    <tr data-type="expense" data-status="approved" data-date="2024-03-07">
                        ...
                        <td>
                            <div class="amount-display expense">$180</div>
                        </td>
                        <td>03/07/2024</td>
                        <td><span class="status-badge approved">Approved</span></td>
                        <td>
                    ...
                    <tr data-type="income" data-status="pending" data-date="2024-04-07">
                        ...
                        <td>
                            <div class="amount-display income">$1,500</div>
                        </td>
                        <td>04/07/2024</td>
                        <td><span class="status-badge pending">Pending</span></td>
                        <td>
